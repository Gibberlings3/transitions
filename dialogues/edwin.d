...
CHAIN
	IF WEIGHT #-999 ~Global("#L_EdwinModded","GLOBAL",0) GlobalLT("EndOfBG1","GLOBAL",1) Global("#l_SarvQuests","GLOBAL",99) GlobalLT("#L_NPCPK","GLOBAL",2) !AreaType(DUNGEON) CombatCounter(0)~ THEN EDWINJ_ POST_KORLASZ_ASK
...
CHAIN
	IF WEIGHT #-998 ~Global("#L_EdwinModded","GLOBAL",0) Global("#L_NPCSoD","GLOBAL",0) GlobalGT("EndOfBG1","GLOBAL",0)~ THEN EDWINJ_ PRE_SOD_WARNING
