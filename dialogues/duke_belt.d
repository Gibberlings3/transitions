...
APPEND BELT
	...
	IF ~~ THEN BELT_NOW_WHAT
		...
		+ ~OR(3) PartyHasItem("#LKey01") PartyHasItem("#LKey02") PartyHasItem("#LKey03")~ + @2266 /* ~I'm going to settle into my new house and sleep for a week.~ */ DO ~SetGlobal("#L_SarvQuests","GLOBAL",100) SetGlobal("EndOfBG1","GLOBAL",1) SetGlobal("#L_StartCaelarAttack","GLOBAL",3) TriggerActivation("Door0109a",FALSE) TriggerActivation("Door0109b",FALSE) TriggerActivation("Door0111",FALSE) TriggerActivation("Door0200",FALSE)~ EXIT
		+ ~!PartyHasItem("#LKey01") !PartyHasItem("#LKey02") !PartyHasItem("#LKey03")~ + @2267 /* ~I think I'll go to Elfsong and celebrate for a week.~ */ DO ~SetGlobal("#L_SarvQuests","GLOBAL",100) SetGlobal("EndOfBG1","GLOBAL",1) SetGlobal("#L_StartCaelarAttack","GLOBAL",4) TriggerActivation("Door0109a",FALSE) TriggerActivation("Door0109b",FALSE) TriggerActivation("Door0111",FALSE) TriggerActivation("Door0200",FALSE)~ EXIT
