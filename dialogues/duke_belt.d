...
APPEND BELT
	...
	IF ~~ THEN BELT_NOW_WHAT
		...
		+ ~Global("#L_AcceptedRoom","GLOBAL",1)~ + @2265 /* ~I think I'll go up stairs and sleep for a week.~ */ DO ~SetGlobal("#L_SarvQuests","GLOBAL",100) SetGlobal("EndOfBG1","GLOBAL",1) SetGlobal("#L_StartCaelarAttack","GLOBAL",1) TriggerActivation("Door0109a",FALSE) TriggerActivation("Door0109b",FALSE) TriggerActivation("Door0111",FALSE) TriggerActivation("Door0200",FALSE)~ EXIT
		+ ~Global("#L_AcceptedRoom","GLOBAL",0) Global("#L_ImoenInPalace","GLOBAL",1) OR(3) PartyHasItem("#LKey01") PartyHasItem("#LKey02") PartyHasItem("#LKey03")~ + @2268	/* ~I'm going to visit Imoen and then go home and sleep for a week.~ */ DO ~SetGlobal("#L_SarvQuests","GLOBAL",100) SetGlobal("EndOfBG1","GLOBAL",1) SetGlobal("#L_StartCaelarAttack","GLOBAL",2) SetGlobal("#L_SkipFirstHalfCA","GLOBAL",1) TriggerActivation("Door0109a",FALSE) TriggerActivation("Door0109b",FALSE) TriggerActivation("Door0111",FALSE) TriggerActivation("Door0200",FALSE)~ EXIT
		+ ~Global("#L_AcceptedRoom","GLOBAL",0) Global("#L_ImoenInPalace","GLOBAL",1) !PartyHasItem("#LKey01") !PartyHasItem("#LKey02") !PartyHasItem("#LKey03")~ + @2269 /* ~I'm going to visit Imoen and then head to Elfsong to celebrate for a week.~ */ DO ~SetGlobal("#L_SarvQuests","GLOBAL",100) SetGlobal("EndOfBG1","GLOBAL",1) SetGlobal("#L_StartCaelarAttack","GLOBAL",2) SetGlobal("#L_SkipFirstHalfCA","GLOBAL",1) TriggerActivation("Door0109a",FALSE) TriggerActivation("Door0109b",FALSE) TriggerActivation("Door0111",FALSE) TriggerActivation("Door0200",FALSE)~ EXIT
		+ ~Global("#L_AcceptedRoom","GLOBAL",0) Global("#L_ImoenInPalace","GLOBAL",0) OR(3) PartyHasItem("#LKey01") PartyHasItem("#LKey02") PartyHasItem("#LKey03")~ + @2266 /* ~I'm going to settle into my new house and sleep for a week.~ */ DO ~SetGlobal("#L_SarvQuests","GLOBAL",100) SetGlobal("EndOfBG1","GLOBAL",1) SetGlobal("#L_StartCaelarAttack","GLOBAL",3) TriggerActivation("Door0109a",FALSE) TriggerActivation("Door0109b",FALSE) TriggerActivation("Door0111",FALSE) TriggerActivation("Door0200",FALSE)~ EXIT
		+ ~Global("#L_AcceptedRoom","GLOBAL",0) Global("#L_ImoenInPalace","GLOBAL",0) !PartyHasItem("#LKey01") !PartyHasItem("#LKey02") !PartyHasItem("#LKey03")~ + @2267 /* ~I think I'll go to Elfsong and celebrate for a week.~ */ DO ~SetGlobal("#L_SarvQuests","GLOBAL",100) SetGlobal("EndOfBG1","GLOBAL",1) SetGlobal("#L_StartCaelarAttack","GLOBAL",4) TriggerActivation("Door0109a",FALSE) TriggerActivation("Door0109b",FALSE) TriggerActivation("Door0111",FALSE) TriggerActivation("Door0200",FALSE)~ EXIT
		++ @2270 /* ~I have places to go, things to do, people to see.~ */ DO ~SetGlobal("#L_SarvQuests","GLOBAL",99)~ + BELT_FUN
		++ @2271 /* ~I think I'll gather up a group and explore a bit, maybe see what's south of Nashkel.~ */ DO ~SetGlobal("#L_SarvQuests","GLOBAL",100) SetGlobal("EndOfBG1","GLOBAL",2) SetGlobal("#L_StartBG2","GLOBAL",1) TriggerActivation("Door0109a",FALSE) TriggerActivation("Door0109b",FALSE) TriggerActivation("Door0111",FALSE) TriggerActivation("Door0200",FALSE)~ EXIT
	END
