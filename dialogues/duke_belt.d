...
APPEND BELT
	...
	IF ~~ THEN BELT_NOW_WHAT
		...
		// Put these back when SoD portion of I4E is finished
//		+ ~Global("#L_AcceptedRoom","GLOBAL",0) Global("#L_ImoenInPalace","GLOBAL",0) OR(3) PartyHasItem("#LKey01") PartyHasItem("#LKey02") PartyHasItem("#LKey03")~ + @2266 /* ~I'm going to settle into my new house and sleep for a week.~ */ DO ~SetGlobal("#L_SarvQuests","GLOBAL",100) SetGlobal("EndOfBG1","GLOBAL",1) SetGlobal("#L_StartCaelarAttack","GLOBAL",3)~ EXIT
//		+ ~Global("#L_AcceptedRoom","GLOBAL",0) Global("#L_ImoenInPalace","GLOBAL",0) !PartyHasItem("#LKey01") !PartyHasItem("#LKey02") !PartyHasItem("#LKey03")~ + @2267 /* ~I think I'll go to Elfsong and celebrate for a week.~ */ DO ~SetGlobal("#L_SarvQuests","GLOBAL",100) SetGlobal("EndOfBG1","GLOBAL",1) SetGlobal("#L_StartCaelarAttack","GLOBAL",3)~ EXIT
		// Special cases that can be removed after SoD portion of I4E is finished
		+ ~OR(2) !Global("C#IM_ImoenComesBackSoD","GLOBAL",0) !Global("C#IM_ImoenInSoD","GLOBAL",1) Global("#L_AcceptedRoom","GLOBAL",0) Global("#L_ImoenInPalace","GLOBAL",0) OR(3) PartyHasItem("#LKey01") PartyHasItem("#LKey02") PartyHasItem("#LKey03")~ + @2266 /* ~I'm going to settle into my new house and sleep for a week.~ */ DO ~SetGlobal("#L_SarvQuests","GLOBAL",100) SetGlobal("EndOfBG1","GLOBAL",1) SetGlobal("#L_StartCaelarAttack","GLOBAL",3)~ EXIT
		+ ~OR(2) !Global("C#IM_ImoenComesBackSoD","GLOBAL",0) !Global("C#IM_ImoenInSoD","GLOBAL",1) Global("#L_AcceptedRoom","GLOBAL",0) Global("#L_ImoenInPalace","GLOBAL",0) !PartyHasItem("#LKey01") !PartyHasItem("#LKey02") !PartyHasItem("#LKey03")~ + @2267 /* ~I think I'll go to Elfsong and celebrate for a week.~ */ DO ~SetGlobal("#L_SarvQuests","GLOBAL",100) SetGlobal("EndOfBG1","GLOBAL",1) SetGlobal("#L_StartCaelarAttack","GLOBAL",3)~ EXIT
		+ ~Global("C#IM_ImoenComesBackSoD","GLOBAL",0) Global("C#IM_ImoenInSoD","GLOBAL",1) Global("#L_ImoenInPalace","GLOBAL",0) OR(3) PartyHasItem("#LKey01") PartyHasItem("#LKey02") PartyHasItem("#LKey03")~ + @2266 /* ~I'm going to settle into my new house and sleep for a week.~ */ DO ~SetGlobal("#L_SarvQuests","GLOBAL",100) SetGlobal("EndOfBG1","GLOBAL",1) SetGlobal("#L_StartCaelarAttack","GLOBAL",4)~ EXIT
		+ ~Global("C#IM_ImoenComesBackSoD","GLOBAL",0) Global("C#IM_ImoenInSoD","GLOBAL",1) Global("#L_ImoenInPalace","GLOBAL",0) !PartyHasItem("#LKey01") !PartyHasItem("#LKey02") !PartyHasItem("#LKey03")~ + @2267 /* ~I think I'll go to Elfsong and celebrate for a week.~ */ DO ~SetGlobal("#L_SarvQuests","GLOBAL",100) SetGlobal("EndOfBG1","GLOBAL",1) SetGlobal("#L_StartCaelarAttack","GLOBAL",5)~ EXIT
