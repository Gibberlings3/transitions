...
REPLACE_ACTION_TEXT %IMOEN_POST% ~!ActionOverride("imoen",JoinParty())~ ~!ActionOverride("imoen2",JoinParty())~
...
APPEND %IMOEN_JOINED%
	IF WEIGHT #-999 ~Global("#L_ImTrainRsp","GLOBAL",1)~ THEN BEGIN IMOEN_TRAINING_RSP_1
		...
		IF ~~ THEN DO ~SetGlobal("#L_ImTrainRsp","GLOBAL",4) ActionOverride("IMOEN2",GivePartyAllEquipment())~ + IMOEN_LIIA_4a
	END
...
CHAIN	
	IF WEIGHT #-996 ~InMyArea("LIIA") Global("#L_ImTrainRsp","GLOBAL",2) Global("#L_LiiaInstalled","GLOBAL",1)~ THEN %IMOEN_JOINED% IMOEN_LIIA_TRAIN_RSP_2
...
CHAIN
	IF WEIGHT #-995 ~GlobalGT("#L_TalkedToDukes","GLOBAL",1) Global("#L_ImTrainRsp","GLOBAL",3) Global("#L_LiiaInstalled","GLOBAL",1)~ THEN %IMOEN_JOINED% IMOEN_LIIA_3
