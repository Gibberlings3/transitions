...
APPEND LIIA
	...
	IF WEIGHT #-998 ~Global("#L_TalkedToDukes","GLOBAL",2) !InPartyAllowDead("%IMOEN_DV%") Global("#L_ImTrainRsp","GLOBAL",0)~ THEN BEGIN LIIA_2
	...
	IF WEIGHT #-997 ~Global("#L_TalkedToDukes","GLOBAL",2) InPartyAllowDead("%IMOEN_DV%") !IsValidForPartyDialogue("%IMOEN_DV%") Global("#L_ImTrainRsp","GLOBAL",0)~ THEN BEGIN LIIA_3
