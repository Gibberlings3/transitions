...
APPEND LIIA
	IF WEIGHT #-999 ~Global("#L_SoD","GLOBAL",1) Global("#L_TalkedToDukes","GLOBAL",2) IsValidForPartyDialogue("%IMOEN_DV%") Global("#L_ImTrainRsp","GLOBAL",0)~ THEN BEGIN LIIA_1
	...
	IF WEIGHT #-998 ~Global("#L_SoD","GLOBAL",1) Global("#L_TalkedToDukes","GLOBAL",2) !InPartyAllowDead("%IMOEN_DV%") Global("#L_ImTrainRsp","GLOBAL",0)~ THEN BEGIN LIIA_2
		...
		++ @2114 /* ~Thank you.  I'll do that.~ */ DO ~SetGlobal("#L_TalkedToDukes","GLOBAL",3) SetGlobal("#L_ImoenInPalace","GLOBAL",1) MoveGlobal("#LBD0103","%IMOEN_DV%",[960.680])~ EXIT
		++ @2115 /* ~Maybe...someday.~ */ DO ~SetGlobal("#L_TalkedToDukes","GLOBAL",3) SetGlobal("#L_ImoenInPalace","GLOBAL",1) MoveGlobal("#LBD0103","%IMOEN_DV%",[960.680])~ EXIT
	END
	...
	IF WEIGHT #-995 ~Global("#L_SoD","GLOBAL",1) !Global("#L_ImoenInPalace","GLOBAL",1) !IsGabber("%IMOEN_DV%")~ THEN BEGIN LIIA_99b
	...
	IF WEIGHT #-994 ~OR(2) Global("#L_SoD","GLOBAL",0) Global("#L_ImoenInPalace","GLOBAL",1)~ THEN BEGIN LIIA_HELLO_AGAIN
