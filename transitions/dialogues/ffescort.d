...
//	END
	...
	IF ~Global("#L_SarvQuests","GLOBAL",3) Dead("SEMAJ") AreaCheck("%NEBaldursGate%")~ THEN BEGIN ESCORT_3
		SAY @2194 /* ~No survivors?~ */
		++ @2195 /* ~I'm afraid not.~ */ + ESCORT_LEAVESa
	END

	IF ~Global("#L_SarvQuests","GLOBAL",4) Dead("Winski2") AreaCheck("%SWBaldursGate%")~ THEN BEGIN ESCORT_4
		SAY @2194 /* ~No survivors?~ */
		++ @2195 /* ~I'm afraid not.~ */ + ESCORT_LEAVESa
	END
	...
	IF ~Global("#L_SarvQuests","GLOBAL",6) Dead("Tamoko") Global("#L_TamokoDie","GLOBAL",0) AreaCheck("%BaldursGateDocks%")~ THEN BEGIN ESCORT_6a
		SAY @2194 /* ~No survivors?~ */
		++ @2195 /* ~I'm afraid not.~ */ + ESCORT_LEAVESa
	END

	IF ~Global("#L_SarvQuests","GLOBAL",6) Global("#L_TamokoSurrend","GLOBAL",1) Global("#L_TamokoDie","GLOBAL",0) AreaCheck("%BaldursGateDocks%")~ THEN BEGIN ESCORT_6b
		SAY @2218 /* ~<PROPER_SIRMAAM>, I stayed behind to inform you that the prisoner has been taken into custody.~ */
		++ @2140 /* ~Thank you.~ */ + ESCORT_LEAVESb
	END

	IF ~Global("#L_SarvQuests","GLOBAL",6) Dead("Tamoko") Global("#L_TamokoDie","GLOBAL",1) AreaCheck("%BaldursGateDocks%")~ THEN BEGIN ESCORT_6c 
	...
	IF ~Global("#L_SarvQuests","GLOBAL",7) Dead("ZHALIMAR") Dead("GARDUSH") Dead("NAAMAN") Dead("DIYAB") Dead("AASIM") Dead("ALAI") AreaCheck("%BaldursGateDocks%")~ THEN BEGIN ESCORT_7
		SAY @2194 /* ~No survivors?~ */
		++ @2195 /* ~I'm afraid not.~ */ + ESCORT_LEAVESa
	END
